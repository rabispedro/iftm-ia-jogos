...
class Agent:
	def __init__(self):
		...
		self.model = Linear_QNet(11, 256, 3) #	11 inputs, 256 deep-queue, 3 responses
	...
	def get_state(self, game):
		...
		dir_l = (game.direction == Direction.LEFT)  # se a direção da cobra for para a esquerda
		dir_r = (game.direction == Direction.RIGHT)  # se a direção da cobra for para a direita
